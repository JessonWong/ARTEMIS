...
class FinePrune(defense):
    ...
    def set_args(self, parser):
        ...
        parser.add_argument('--defense_save_path', type=str, help='the location of save')
    ...
    def process_args(self, args):
        ...
        defense_save_path = args.defense_save_path
    ...
    def prepare(self, args):
        ...
        '''
                ...
                '''
        self.attack_result = load_attack_result(self.args.result_file)
    ...
    def defense(self):
        ...
        for num_pruned in range(0, len(seq_sort), math.ceil(len(seq_sort) * args.once_prune_ratio)):
            ...
            if num_pruned == 0:
                ...
                last_net = (net_pruned)
                last_index = 0
            print(f"acc ratio now : {abs(test_acc - test_acc_cl_ori) / test_acc_cl_ori}")
...
# --result_file /content/BackdoorBench/record/trojannn_attack_gtsrb/attack_result.pt \
# --defense_save_path ./record/defense/fp_defense/defense_fp_trojannn_gtsrb \
# --yaml_path ./config/defense/ft/gtsrb.yaml \
# --once_prune_ratio 0.5 --acc_ratio 0.9